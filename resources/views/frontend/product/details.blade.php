                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="detail-extralink mb-50">
                                    <div class="detail-qty border radius">
                                        ...
                                        <input type="text" id="dquantity" name="quantity" class="qty-val" value="1" min="1">
                                ...
                                <div class="font-xs">
                                    <ul class="mr-50 float-start">
                                        <li class="mb-5">Category: <span
                                                class="text-brand">{{ ucfirst($product->category->name) }}</span></li>
                                        <li class="mb-5">Subcategory:<span class="text-brand">
                                                {{ ucfirst($product->subcategory->name) }}</span></li>
                                        <li>Brand: <span class="text-brand">{{ ucfirst($product->brand->name) }}</span>
                                        </li>
                                    </ul>
                                        ...
                                        <div class="product-cart-wrap hover-up">
                                            ...
                                            <div class="product-content-wrap">
                                                <h2><a href="shop-product-right.html"
                                                        tabindex="0">{{ ucfirst($product->name) }}</a>
                                                </h2>
